...
def main():
    ...
    # 画像をロード
    image_tensor = brain.image_transform(
    ...
    if objects:
        ...
        for obj in objects:
            ...
            print(
                f"    Active Neurons: {spatial_spikes.sum().item()} / {spatial_spikes.numel()}")
    ...
    print(
        f"  Routing Weights (With Visual Context): {weights_with_ctx.detach().numpy()}")
